...
destroy threads frequently, reusing these structures pays off.\margin{glibc does the same for NPTL threads: a freed stack stays in a
cache of up to \SI{40}{\mebi\byte} (tunable
\texttt{glibc.pthread.stack\_cache\_size}) and is handed to the next
\texttt{pthread\_create}.}  When a
