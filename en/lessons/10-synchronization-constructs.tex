...
\begin{description}
  \item[NCC] Neither the read nor the atomic instruction can be served from
    ...
    contention is no better than with the plain loop.
...
of the release.  When critical sections are short and many threads wait,
...
write-invalidate caches \cite{anderson1990}.  Under high load---many CPUs
...
expected contention and on the instructions the platform provides.
