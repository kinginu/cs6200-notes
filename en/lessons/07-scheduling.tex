...
the expired array.\margin{In the Linux~2.6 kernels a task judged interactive
was normally returned to the active array instead, unless the tasks in the
expired array had already waited too long.}  When no more tasks remain in the active array, the
