...
\begin{example}
  ...
  in hardware, because the mappings already permit them.\tip{Per node the
  mapping of a page is a three-state machine---none, RO, RW---and only the
  transitions fault: a read takes none to RO, a write RO to RW; another
  node's access downgrades it to RO or to none.}
\end{example}
