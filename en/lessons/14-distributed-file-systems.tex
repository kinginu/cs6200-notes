...
request for the attributes of the file.\margin{The handle is
\SI{32}{\byte} and of fixed size in NFSv2; later versions make it variable,
at most \SI{64}{\byte} in NFSv3 \cite{rfc1813} and \SI{128}{\byte} in NFSv4
\cite{rfc7530}.}  A server typically encodes in the
