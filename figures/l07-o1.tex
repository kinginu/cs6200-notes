...
\begin{tikzpicture}[x=1mm, y=1mm, font=\scriptsize\sffamily,
  ...
  % rows: label / y
  % \vdots resolves to U+22EE, which the Japanese sans font lacks; take it
  % from the math font in the Japanese edition.
  \def\lnvdots{\iflangja{\ensuremath{\vdots}}{\vdots}}
  \def\rows{0/0, {\lnvdots}/-4.5, 99/-9, 100/-13.5, {\lnvdots}/-18, 120/-22.5, {\lnvdots}/-27, 139/-31.5}
  ...
  \foreach \y/\b in {0/0, -9/0, -13.5/1, -22.5/1, -31.5/0} {
    \node[bit] at (76,\y) {\b};
    \node[slot] at (91,\y) {};
  }
  \node[tk] (e0) at (99,-13.5) {};
  \draw[->] (91,-13.5) -- (e0);
  \node[tk] (e1) at (99,-22.5) {};
  \draw[->] (91,-22.5) -- (e1);
  % the running task is the first task of the highest-priority non-empty
  % list; when its timeslice expires it moves to the expired array
  \draw[->, thick, ln-accent, rounded corners=2mm]
    (a1.east) -- (55,-13.5) -- (55,-37.5) -- (106,-37.5) -- (106,-13.5) -- (e0.east);
  \node[above, text=ln-accent, inner sep=1pt] at (80,-37.5) {\iflangja{タイムスライス満了}{timeslice expires}};
  % swap
