...
\begin{tikzpicture}[x=1mm, y=1mm, font=\scriptsize\sffamily,
  ...
  \node[lab] at (39,27) {\iflangja{内側の表へ}{$\to$ inner}};
  % inner page table
  \node[hd] at (73,44) {\iflangja{内側の\\ページテーブル}{inner\\page table}};
  ...
  % the Japanese label is longer: place it left of the arrow so that the
  % picture still fits the 120 mm body width (the English output is unchanged)
  \node[idx, anchor=\iflangja{east}{west}] at (\iflangja{106}{107.5},2)
    {\iflangja{オフセット}{offset}};
\end{tikzpicture}
