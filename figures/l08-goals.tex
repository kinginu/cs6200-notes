...
\begin{tikzpicture}[x=1mm, y=1mm, font=\scriptsize\sffamily,
  ...
  % page frames 0..5 (height 6: page frames have the size of a page)
  \foreach \i in {0,...,5} { \draw[oth] (38,6*\i) rectangle ++(14,6); }
  \foreach \i in {0,2,3,5} { \draw[pg] (38,6*\i) rectangle ++(14,6); }
  \foreach \i in {1,4} { \node[lab, text=ln-muted] at (45,3+6*\i) {\iflangja{他}{other}}; }
  % disk
  \draw[fill=ln-box, rounded corners=2pt] (38,-11) rectangle (52,-4)
    node[midway, lab] {\iflangja{ディスク}{disk}};
  % mappings: page -> frame
  \foreach \j/\i in {0/3, 1/2, 4/5, 5/0} {
    \draw[->] (16,3+6*\j) -- (38,3+6*\i);
  }
  \draw[->] (16,15) -- (38,-7.5);
