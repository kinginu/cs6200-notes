...
\begin{tikzpicture}[x=1mm, y=1mm, font=\scriptsize\sffamily,
  ...
  \draw[->, thick, ln-caution] (54.3,15) to[out=0, in=0, looseness=2.2]
    node[right=0.8mm, text=ln-caution] {} (54.3,9);
  % Both labels are wider than the gap between panels (b) and (c), whose
  % white boxes would cover them, so they are set vertically beside the arc.
  \node[text=ln-caution, rotate=90] at (60.3,12) {\iflangja{トラップ}{trap}};
