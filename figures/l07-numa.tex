...
\begin{tikzpicture}[x=1mm, y=1mm, font=\footnotesize\sffamily,
  ...
  \draw[nd] (2,20) rectangle (45,-12);
  \draw[nd] (67,20) rectangle (110,-12);
  ...
  % remote access: down out of node 1, along the interconnect, into the
  % memory of node 0
  \draw[<->, thick, densely dashed, ln-caution, rounded corners=1.5mm]
    (c2.south west) -- (52,11) -- (52,-6) -- (m0.east);
  \node[lab, text=ln-caution] at (58.5,6) {\iflangja{リモート：\\遅い}{remote:\\slow}};
\end{tikzpicture}
