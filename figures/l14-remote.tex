...
\begin{tikzpicture}[x=1mm, y=1mm, font=\scriptsize\sffamily,
  ...
  % \ts: extra title shift in the Japanese edition, where the (a) title is
  % wider than its panel and would run into the (b) title.
  \foreach \px/\ts/\t in {0/0/{\iflangja{(a) アップロード・ダウンロード}{(a) upload/download}},
                      40/2/{\iflangja{(b) 遠隔アクセス}{(b) remote access}},
                      80/2/{\iflangja{(c) 折衷案}{(c) compromise}}} {
    \node[ttl] at (\px+\iflangja{\ts}{0},44) {\t};
