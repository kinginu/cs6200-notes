...
\begin{tikzpicture}[x=1mm, y=1mm, font=\footnotesize\sffamily,
  ...
  \node[lab, anchor=east] at (105.5,-7) {\iflangja{受信で待つ}{blocked in receive}};
  \draw[bar] (9,-21) rectangle (11,-55);
  \node[lab, anchor=west] at (12.5,-24) {\iflangja{受信で待つ}{blocked in receive}};
  % messages
  \draw[->] (10,-12) -- node[msg] {1\ \iflangja{データを書く}{write data}} (44,-12);
  \draw[->] (10,-19) -- node[msg, pos=0.62] {2\ \iflangja{ready を送信}{send ready}} (78,-19);
  \draw[->] (78,-28) -- node[msg] {3\ \texttt{ready}} (108,-28);
  \draw[->] (108,-37) -- node[msg, pos=0.6] {4\ \iflangja{データを読む}{read data}} (44,-37);
  \draw[->] (108,-46) -- node[msg] {5\ \iflangja{ok を送信}{send ok}} (78,-46);
