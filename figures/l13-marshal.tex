...
% Usage: \input{figures/l13-marshal}   (width ~120 mm)
\begin{tikzpicture}[x=1mm, y=1mm, font=\footnotesize\sffamily,
  ...
  \node[hdr] at (105,42) {\iflangja{サーバのアドレス空間}{server address space}};
  \node[lab, anchor=west] at (90,36.5) {\iflangja{スタック}{stack}};
  \node[var] (sc) at (111,31) {3};
  \node[var] (sv) at (111,25) {\texttt{0x9c40}};
  \node[vname] at (102.5,31) {\texttt{count}};
  \node[vname] at (102.5,25) {\texttt{values}};
  \node[elem] (s1) at (101.5,9) {7};
  \node[elem] (s2) at (108.5,9) {$-2$};
  \node[elem] (s3) at (115.5,9) {300};
  \node[addr, anchor=north west] at (98,6.3) {0x9c40};
  \node[lab, anchor=east] at (97.6,9) {\iflangja{ヒープ}{heap}};
  \draw[->] ([xshift=-4mm]sv.south) -- (s1.north);
  % ---------------- operations
  \draw[->, thick, ln-accent] (31,20) -- (44.5,20);
  \node[op] at (37.8,20.8) {\iflangja{マーシャル}{marshal}};
  \draw[->, thick, ln-accent] (75.5,20) -- (89,20);
  \node[op] at (82.3,20.8) {\iflangja{アンマーシャル}{unmarshal}};
\end{tikzpicture}
