...
\begin{tikzpicture}[x=1mm, y=1mm, font=\scriptsize\sffamily,
  ...
  \draw[draw=ln-accent, thick, fill=ln-box, rounded corners=2pt] (0,11) rectangle (96,38);
  ...
  \node[blk, minimum width=47mm, minimum height=7mm] at (23.5,5)
    {\textbf{I/O Kit}\quad \iflangja{デバイスドライバ}{device drivers}};
  \node[blk, minimum width=47mm, minimum height=7mm] at (72.5,5)
