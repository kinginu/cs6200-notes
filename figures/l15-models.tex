% Operations for the consistency-model example: P1 and P2 write m1 and m2,
% P3 and P4 read both locations in opposite orders, a synchronization point
% follows at t5, and P4 reads m1 again at t6.  P2's read of m1 (grey) is
...
\begin{tikzpicture}[x=1mm, y=1mm, font=\scriptsize\sffamily,
  ...
  % P1, P2 writes
  \node[ev] at (24,27) {};  \node[lab, anchor=south] at (24,28) {$W_{m_1}(1)$};
  \node[ev] at (40,18) {};  \node[lab, anchor=south] at (40,19) {$W_{m_2}(2)$};
  \node[ev, fill=ln-muted] at (31,18) {};
  \node[lab, anchor=north, text=ln-muted] at (29,17) {($R_{m_1}(1)$)};
  % P3 reads
  \node[ev] at (56,9) {};  \node[lab, anchor=south] at (56,10) {$R_{m_1}(?)$};
  \node[ev] at (72,9) {};  \node[lab, anchor=south] at (72,10) {$R_{m_2}(?)$};
  % P4 reads
  \node[ev] at (56,0) {};  \node[lab, anchor=south] at (56,1) {$R_{m_2}(?)$};
  \node[ev] at (72,0) {};  \node[lab, anchor=south] at (72,1) {$R_{m_1}(?)$};
  \node[ev] at (104,0) {}; \node[lab, anchor=south] at (104,1) {$R_{m_1}(?)$};
  % time axis
  \draw[->] (16,-6) -- (113,-6);
  \foreach \ti in {1,...,6} {
