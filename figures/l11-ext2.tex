...
\begin{tikzpicture}[x=1mm, y=1mm, font=\scriptsize\sffamily,
  ...
  \node[note] at (11.5,-5) {\iflangja{ファイルシステム全体の数とサイズ（コピー）}{file-system-wide counts and sizes (copy)}};
  \node[note] at (30.5,-5) {\iflangja{全ブロックグループの記述子（コピー）}{descriptors of all groups (copy)}};
  \node[note] at (49,-5) {\iflangja{空きブロックを記録}{tracks free blocks}};
  \node[note] at (67,-5) {\iflangja{空き iノードを記録}{tracks free inodes}};
  \node[note] at (85,-5) {\iflangja{iノード番号の連続した範囲}{a range of the inode numbers}};
