...
\begin{tikzpicture}[x=1mm, y=1mm, font=\footnotesize\sffamily,
  ...
  % fork: the new child, not the caller, joins the ready queue
  \node[bx] (ch) at (63,3) {\iflangja{新しい子プロセス}{new child process}};
  \draw[->] (102,3) -- node[lab, above] {\iflangja{子を fork}{fork a child}} (ch.east);
  \draw (ch.west) -- (2,3);
  % interrupt
