...
\begin{tikzpicture}[x=1mm, y=1mm, font=\footnotesize\sffamily,
  ...
  mod/.style={box, fill=white, minimum width=10.5mm, minimum height=8mm,
    font=\tiny\sffamily},
  th/.style={draw, circle, minimum size=4.2mm, inner sep=0pt, font=\tiny\sffamily},
  ...
  \foreach \px/\n in {56/1,84/2} {
    ...
    \foreach \i in {0,1,2} { \draw[->] (\px+12.5,18.3) -- (\px+5.5+7*\i,14.8); }
    \node[font=\tiny\sffamily, text=ln-muted] at (\px+12.5,1.8)
