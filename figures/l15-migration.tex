...
% which accesses it; (b) nodes B and C read replicas of p locally, and a
% write by A makes the DSM invalidate them (dashed).
...
\begin{tikzpicture}[x=1mm, y=1mm, font=\scriptsize\sffamily,
  ...
  invd/.style={draw, densely dashed, ln-caution, fill=ln-accent!12, minimum width=9mm, minimum height=5mm, inner sep=0pt},
