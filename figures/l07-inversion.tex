...
\begin{tikzpicture}[x=9mm, y=1mm, font=\footnotesize\sffamily,
  ...
  \begin{scope}[yshift=-17mm, font=\scriptsize\sffamily]
    ...
    \draw[blk] (5.3,0) -- (6,0);
    \node[anchor=west] at (6.05,0) {\iflangja{m 待ちでブロック}{blocked on m}};
    \draw[boost] (8.2,-1.5) rectangle (8.7,1.5);
    \node[anchor=west] at (8.75,0) {\iflangja{継承した優先度}{inherited priority}};
  \end{scope}
\end{tikzpicture}
